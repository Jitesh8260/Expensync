...
const dummyTransactions = [
    { _id: "1", title: "Zomato Order", category: "Food", amount: -450 },
    { _id: "2", title: "Salary", category: "Income", amount: 20000 },
    { _id: "3", title: "Netflix", category: "Entertainment", amount: -499 },
    { _id: "4", title: "Electricity Bill", category: "Utilities", amount: -1250 },
    { _id: "5", title: "Flight Refund", category: "Others", amount: 3000 },
];
...
const Transactions = ({ userId }) => {
    ...
    const fetchAll = async () => {
        setTransactions(dummyTransactions); // Replace with actual API later
    };
                        ...
                        <div className="bg-gradient-to-b from-slate-100/60 to-slate-200/60 dark:from-[#0c0f1c] dark:to-[#1a1d2e]  p-6 sm:p-8 rounded-3xl shadow-xl border border-slate-200 dark:border-slate-700 h-fit transition-all duration-300 backdrop-blur-sm">
                            ...
                            <ul className="space-y-4 text-slate-700 dark:text-slate-300 text-base leading-relaxed">
                                ...
                                <li>
                                    ...
                                    <span
                                        className={`font-bold transition-all duration-500 ${net < 0 ? "text-red-500" : "text-green-500"
                                            }`}
                                    >
                                        ₹{net}
                                    </span>
